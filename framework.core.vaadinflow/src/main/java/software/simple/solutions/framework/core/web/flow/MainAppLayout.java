...
public class MainAppLayout extends AppLayoutRouterLayout {
	...
	public AppLayout createAppLayoutInstance() {
		...
		AppLayout build = AppLayoutBuilder.get(Behaviour.LEFT_HYBRID).withTitle("App Layout")
				...
				.withAppMenu(
						LeftAppMenuBuilder.get()
								...
								.addToSection(new LeftClickableComponent("Clickable Entry", VaadinIcon.COG.create(),
										clickEvent -> Notification.show("onClick ...")), HEADER)
								.add(new LeftNavigationComponent("ViewA", VaadinIcon.COG.create(), ViewA.class))
