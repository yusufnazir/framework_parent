...
public class ProfilePreferencesWindow extends Window {
	...
	private ProfilePreferencesWindow(final ApplicationUser user, final boolean preferencesTabOpen) {
	...
	private Component buildFooter() {
		...
		ok.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				SimpleSolutionsEventBus.post(new ProfileUpdatedEvent());
				close();
			}
		});
		ok.focus();
	...
	public static void open(final ApplicationUser user, final boolean preferencesTabActive) {
