...
public class CxodeConfigurationModuleContext {
	...
	public void init() {
		...
		for (BeanDefinition component : components) {
			...
			Class<? extends com.vaadin.ui.Component> class1 = (Class<? extends com.vaadin.ui.Component>) ClassUtils
	...
	public class CxodeConfigurationItem implements Comparator<CxodeConfigurationItem> {
		private Class<? extends com.vaadin.ui.Component> configurationClass;
		private int order;
		private String captionKey;

		public Class<? extends com.vaadin.ui.Component> getConfigurationClass() {
			return configurationClass;
		}

		public void setConfigurationClass(Class<? extends com.vaadin.ui.Component> configurationClass) {
