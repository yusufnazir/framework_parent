...
//		setCompositionRoot(buildMenu());
	...
	// private Component buildTitle() throws FrameworkException {
	// Label applicationNameFld = new Label();
	// applicationNameFld.setContentMode(ContentMode.HTML);
	// applicationNameFld.setSizeUndefined();
	// HorizontalLayout logoWrapper = new HorizontalLayout(applicationNameFld);
	// logoWrapper.setComponentAlignment(applicationNameFld,
	// Alignment.MIDDLE_CENTER);
	// logoWrapper.addStyleName("valo-menu-title");
	// logoWrapper.setSpacing(false);
	// logoWrapper.setVisible(false);
	//
	// IConfigurationService configurationService =
	// ContextProvider.getBean(IConfigurationService.class);
	// Configuration configuration =
	// configurationService.getByCode(ConfigurationProperty.APPLICATION_NAME);
	// if (configuration != null &&
	// StringUtils.isNotBlank(configuration.getValue())) {
	// applicationNameFld.setValue(configuration.getValue());
	// logoWrapper.setVisible(true);
	// }
	//
	// return logoWrapper;
	// }
	...
	// settingsItem = settings.addItem("", new
	// ThemeResource("img/profile-pic-300px.jpg"), null);
	// updateUserName(null);
	// settingsItem.addItem(
	// PropertyResolver.getPropertyValueByLocale("system.settings.profile.edit.profile",
	// getLocale()),
	// new Command() {
	// @Override
	...
	// });
	// settingsItem.addItem(
	// PropertyResolver.getPropertyValueByLocale("system.settings.profile.preferences",
	// getLocale()),
	// new Command() {
	// @Override
	// public void menuSelected(final MenuItem selectedItem) {
	...
	// settingsItem.addItem(PropertyResolver.getPropertyValueByLocale("system.settings.profile.sign.out",
	// getLocale()),
	// new Command() {
	// @Override
	// public void menuSelected(final MenuItem selectedItem) {
...
//		settingsItem.setText(user.getUsername());
	...
	// }
	//
	// private void manageItemClick(SimpleSolutionsMenuItem
	// simpleSolutionsMenuItem) throws FrameworkException {
